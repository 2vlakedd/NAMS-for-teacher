...
import com.forappnams.nfcattendance.R;
...
public class regi extends AppCompatActivity {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                InsertData();
                 ...
                 boolean isInserted =mDatabaseHelper.insertData(edit_message.getText().toString(),
                                editText.getText().toString());

                        if(isInserted==true)

                            Toast.makeText(regi.this,"Data Inserted",Toast.LENGTH_SHORT).show();
    ...
    private void InsertData() {
        ...
        user.put("IDNumber",edit_message.getText().toString().trim() );
        user.put("StudentName",editText.getText().toString().trim() );
        db.collection("Students")
                ...
                .addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentReference> task) {
                        ...
                        Toast.makeText(regi.this,"Successfully added",Toast.LENGTH_SHORT).show();
