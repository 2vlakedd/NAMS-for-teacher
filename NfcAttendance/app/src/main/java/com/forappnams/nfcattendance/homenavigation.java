...
import com.forappnams.nfcattendance.databinding.ActivityHomenavigationBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     setContentView(binding.getRoot());
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                ...
                .build();
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_homenavigation);
